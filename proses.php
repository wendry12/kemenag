...
<html lang="en">
  ...
  <head>
    <title>Cek &mdash; Website Cek Porsi Haji Lingga</title>
    <meta charset="utf-8">
    ...
    <link href="css/ccss/main.css" rel="stylesheet" />
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
      ...
      <form action="hasil.php" method="POST">
        <div class="inner-form">
          <div class="input-field first-wrap">
            ...
            <input id="search" type="text" name="cari" placeholder="Masukan Nomor Porsi" />
          </div>
    ...
    <script src="js/jjs/extention/choices.js"></script>
        </div>
      </div>
    </div>
